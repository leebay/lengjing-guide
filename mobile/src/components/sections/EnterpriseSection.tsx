      ...
      <div className="container relative z-10">
        ...
        >
          ...
          <div className="ml-auto text-right">
            <h2 className="text-lg font-bold text-[#0a1e3d] leading-tight">校企精品与教材</h2>
            <p className="text-[10px] font-semibold tracking-[0.15em] mt-0.5" style={{ color: `${COLOR}99` }}>
              ELITE COURSES & TEXTBOOKS
            </p>
          </div>
          <div
          ...
          >
            <Award className="w-4 h-4" style={{ color: COLOR }} />
          </div>
        </div>
        ...
        >
          <p className="text-[13px] text-[#0a1e3d]/65 leading-[1.9] mb-5">
            深度校企合作成果展示，产教融合精品内容汇聚。配套权威职教教材、机型资料库与作业手册，为实训教学提供全面支撑，助力培养符合行业需求的高素质技能人才。
          </p>
        </div>
        ...
        {/* Image card */}
        <div
          className={`relative rounded-2xl overflow-hidden shadow-[0_4px_20px_rgba(0,206,201,0.08)] transition-all duration-700 delay-400 ${
            isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
          }`}
        >
          <img
